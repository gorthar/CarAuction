...
public class AuctionsController : ControllerBase
{
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<AuctionDtos>> GetAuctionById(Guid id)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<AuctionDtos>> UpdateAuction(Guid id, UpdateAuctionDto updateAuctionDto)
    {
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult<AuctionDtos>> DeleteAuction(Guid id)
    {
